...
const despliega_rating = () => {
    ...
    enduro.innerHTML = rating;

    enduro.onclick = despliega_nombre;
...
const despliega_nombre = () => {
    ...
    enduro.innerHTML = nombre;

    enduro.onclick = despliega_rating;
